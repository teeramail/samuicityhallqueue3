...
class OnboardshowsDAO {
  constructor() {
    this.collection = 'onboardshows';
  }

  // Find all onboardshows
  async find(query = {}) {
    try {
      ...
      console.error('Error finding onboardshows:', error);
      throw error;
    }
  }

  // Find one onboardshow by ID
  async findOne(query) {
    try {
      if (query.idshow) {
      ...
      console.error('Error finding one onboardshow:', error);
      throw error;
    }
  }
  ...
  async findOneAndUpdate(query, update, options = {}) {
    try {
      ...
      console.error('Error updating onboardshow:', error);
      throw error;
    }
  }
  ...
  async create(data) {
    try {
      ...
      console.error('Error creating onboardshow:', error);
      throw error;
    }
  }
}
...
module.exports = new OnboardshowsDAO(); 