...
class RegisshowsDAO {
  ...
  async find(query = {}) {
    try {
      ...
      console.error('Error finding regisshows:', error);
      throw error;
    }
  }

  // Find one regisshow by ID
  async findOne(query) {
    try {
      if (query.idshow) {
      ...
      console.error('Error finding one regisshow:', error);
      throw error;
    }
  }
  ...
  async findOneAndUpdate(query, update, options = {}) {
    try {
      ...
      console.error('Error updating regisshow:', error);
      throw error;
    }
  }
  ...
  async create(data) {
    try {
      ...
      console.error('Error creating regisshow:', error);
      throw error;
    }
  }
}
...
module.exports = new RegisshowsDAO(); 